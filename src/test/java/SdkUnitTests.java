import com.docusign.click.api.*;
import com.docusign.click.client.*;
import com.docusign.click.model.*;
import com.docusign.click.client.auth.OAuth;
import com.docusign.click.client.auth.OAuth.UserInfo;
...
public class SdkUnitTests {
	...
	private static final String BaseUrl = "https://demo.docusign.net/clickapi";
	...
	public void GetClickwrapsTest() {
		...
		try {
			...
			ClickwrapVersionsResponse clickwrapVersionsResponse = accountsApi.getClickwraps(accountId, accountsApi.new GetClickwrapsOptions());

			Assert.assertNotNull(clickwrapVersionsResponse);
			Assert.assertNotNull(clickwrapVersionsResponse.getClickwraps());
			
			System.out.println("ClickwrapVersionsResponse: " + clickwrapVersionsResponse);
		} catch (ApiException ex) {
